        ...
        while(_alt!=2 && _alt!=antlr4.atn.ATN.INVALID_ALT_NUMBER) {
            if(_alt===1) {
                ...
                case 7:
                    ...
                    this._errHandler.sync(this);
                    _la = this._input.LA(1);
                    if(((((_la - 7)) & ~0x1f) == 0 && ((1 << (_la - 7)) & ((1 << (miniJavaParser.T__6 - 7)) | (1 << (miniJavaParser.T__25 - 7)) | (1 << (miniJavaParser.T__26 - 7)) | (1 << (miniJavaParser.T__32 - 7)) | (1 << (miniJavaParser.T__33 - 7)) | (1 << (miniJavaParser.T__34 - 7)) | (1 << (miniJavaParser.Number - 7)) | (1 << (miniJavaParser.Identifier - 7)))) !== 0)) {
                        this.state = 201;
                        this.expression(0);
                        this.state = 206;
                        this._errHandler.sync(this);
